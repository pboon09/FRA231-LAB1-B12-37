...
#ifndef Read_Encoder_types_h_
#define Read_Encoder_types_h_
#include "rtwtypes.h"
...
typedef struct tag_RTM_Read_Encoder_T RT_MODEL_Read_Encoder_T;

#endif                                 /* Read_Encoder_types_h_ */
