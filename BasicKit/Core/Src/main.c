...
void MX_ADC1_Init(void)
{
  ...
  PA0   ------> ADC1_IN1
  */
  GPIO_InitStruct.Pin = Analog_Read_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(Analog_Read_GPIO_Port, &GPIO_InitStruct);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /**/
  GPIO_InitStruct.Pin = ReadB_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(ReadB_GPIO_Port, &GPIO_InitStruct);

  /**/
  GPIO_InitStruct.Pin = ReadA_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(ReadA_GPIO_Port, &GPIO_InitStruct);
